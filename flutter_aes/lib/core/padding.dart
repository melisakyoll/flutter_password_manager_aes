...
class PaddingWidget extends Padding {
  ...
  static EdgeInsets bottomOnlyPadding = EdgeInsets.only(bottom: 50.0);

  static EdgeInsets onlyVertical = EdgeInsets.symmetric(vertical: 8.0);

  static EdgeInsets paddingTitle = EdgeInsets.only(top: 30, left: 50);

  static EdgeInsets allPadding = EdgeInsets.all(15);

  PaddingWidget(
      EdgeInsets horzonVertical,
      EdgeInsets bottomNavPadding,
      EdgeInsets randomHorizonVertical,
      EdgeInsets bottomOnlyPadding,
      EdgeInsets onlyVertical,
